...
const tabs: { id: EstoqueTab; label: string; icon: React.ReactNode }[] = [
  ...
  { id: 'saida', label: 'Saída p/ Balcão', icon: <Send size={16} /> },
  { id: 'producao', label: 'Produção', icon: <Factory size={16} /> },
  { id: 'montagem', label: 'Montagem', icon: <Layers size={16} /> },
  { id: 'transferencia', label: 'Transferência', icon: <ArrowRightLeft size={16} /> },
  { id: 'receitas', label: 'Receitas', icon: <BookOpen size={16} /> },
  { id: 'inventario', label: 'Inventário', icon: <ClipboardCheck size={16} /> },
  { id: 'historico', label: 'Histórico', icon: <List size={16} /> },
